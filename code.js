    ...
    fetch(url)
        ...
        .then(data => {
            ...
            if (data.results.length === 0) {
                container.innerHTML = `<p>No results found.</p>`; // Handle empty result  
                return;
            }
            data.results.forEach(item => {
                ...
                <div class="col-md-4 col-sm-6 col-lg-3 col-xl-2">
                        ...
                        <img src="https://image.tmdb.org/t/p/original/${item.poster_path}" alt="${title}" style="width: 100%; height: auto; border-radius: 5px;">  

                        <div class="title mb-2" style="text-align: center; font-size: 10px; margin-top: 10px;">  
                            <a href="/watch.html?id=${item.id}" data-bs-theme="dark" style="color: #ecf0f1; text-decoration: none;">${title}</a>  
                        </div>  
                 </div>  
